...
const reply = (commentId, isTargetLink) => {
	...
	//
	const commentLi = document.getElementById(commentId).parentElement;
	const liChildren = commentLi.children;
	const numLiChildren = liChildren.length;
	const lastChild = liChildren[numLiChildren - 1];
	const isUnorderedList = lastChild.tagName === 'UL';
